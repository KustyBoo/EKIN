...
void handleSubmit() async {
  ...
  try {
    ...
    Provider.of<ProviderShoeReviews>(context, listen: false).addReview(newReview);

    // Instantiate ShoeReviewsService directly and add the review to Firebase
    String shoeUid = "uid_sepatu";
    String userEmail = email!;
    ShoeReviewsService shoeReviewsService = ShoeReviewsService();
    await shoeReviewsService.addReviewToFirebase(shoeUid, newReview, userEmail);
